...
import com.dronebot.adapters.simradio.{Calibration}
import com.dronebot.app.config.AxisRange
import com.dronebot.core.domain.flight._
import com.dronebot.core.flightcontrol.checks.TestFlightRunner
...
final class UILayerFx[F[_]](
  ...
  def show(): Unit = {
    ...
    val mapView       = new TelemetryMapView("XY Map", 250.0, 0.5) // use positional args
